        ...
        for (int j = 0; j < multBins; ++j) {
                ...
                if (j == 0) {
                        ...
                        if (j == merge1){
                                ...
                                if (strcmp(system,"PAP") == 0){
                                        nump[0]->SetMaximum(1.29);
                                        nump[0]->SetMinimum(0.85);
                                ...
                                if (strcmp(system,"PP") == 0) {
                                        ...
                                        myLegend->AddEntry(nump[0]," p#bar{p} 0-10%","p");
                                }
...
//				myLegend->AddEntry(nump[merge1+1],"10-30%","p");
...
//				myLegend->AddEntry(nump[merge2+1],"30-50%","p");
                                if (strcmp(system,"PP") == 0) {
